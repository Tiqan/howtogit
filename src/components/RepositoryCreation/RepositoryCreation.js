import style from './RepositoryCreation.module.css'
...
const RepositoryCreation = () => {
    return (
        <div className={style.body}>
            ...
            <p className={style.text}>then initialize a new repository by running the command</p>
            <div className={style.terminal}>
                <p>git init</p>
            </div>
            ...
            <p className={style.text}>give your repository a name and create the repository</p>
